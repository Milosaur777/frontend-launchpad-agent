...
export default function Home() {
  ...
  return (
    <div className="relative bg-storm-void">
      ...
      {/* ═══════ Energy Orbs ═══════ */}
      <EnergyOrb color="rgba(194, 172, 123, 0.15)" className="w-[300px] h-[300px] md:w-[600px] md:h-[600px] -top-20 md:-top-40 -left-20 md:-left-40" blur={isMobile ? 40 : 100} />
      <EnergyOrb color="rgba(30, 107, 138, 0.12)" className="w-[250px] h-[250px] md:w-[500px] md:h-[500px] top-[20%] -right-20 md:-right-40" blur={isMobile ? 40 : 100} />
      <EnergyOrb color="rgba(212, 163, 115, 0.1)" className="w-[200px] h-[200px] md:w-[400px] md:h-[400px] top-[40%] md:top-[60%] left-[10%] md:left-[20%]" blur={isMobile ? 30 : 100} />
      <EnergyOrb color="rgba(139, 0, 0, 0.08)" className="w-[175px] h-[175px] md:w-[350px] md:h-[350px] bottom-[5%] md:bottom-[10%] right-[20%] md:right-[30%]" blur={isMobile ? 30 : 100} />
